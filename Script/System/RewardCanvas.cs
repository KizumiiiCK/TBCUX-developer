        ...
        switch (rt)
        {
            case RewardType.character:
                ...
                AsyncIconLoader.Instance.Load(gameObject,
                    RewardIconHelper.GetCatDeployIconPath(rewardcode.ToString("0000"), 0),
                    sprite => { if (character_image != null) character_image.sprite = sprite; });
                reward_count.text = "+1";
                reward_stack.text = "";
                break;
            case RewardType.UnlockTire:
                ...
                character_image.gameObject.SetActive(true);
                AsyncIconLoader.Instance.Load(gameObject,
                    RewardIconHelper.GetUnlockTireIconPath(rewardcode),
                    sprite => { if (character_image != null) character_image.sprite = sprite; });
                reward_count.text = "+1";
                reward_stack.text = "";
                break;
