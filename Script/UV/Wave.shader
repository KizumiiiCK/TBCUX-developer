    ...
    SubShader {
        ...
        Pass {
            ...
            struct appdata {
                ...
                float2 uv : TEXCOORD0;
                fixed4 color  : COLOR;   // ←新增：接收 Image.color
            };

            struct v2f {
                float2 uv : TEXCOORD0;
                float4 vertex : SV_POSITION;
                fixed4 color : COLOR;   // 新增：接收顶点色
            };
            ...
            v2f vert(appdata v) {
                ...
                o.uv = v.uv;
                o.color = v.color;      // 新增：把 Image.color 传下去
                return o;
            }
            ...
            fixed4 frag(v2f i) : SV_Target {
                ...
                fixed originalA = tex2D(_MainTex, i.uv).a; // 原图 alpha
                col.a = originalA * i.color.a;             // 原图 alpha × Image.color.alpha
